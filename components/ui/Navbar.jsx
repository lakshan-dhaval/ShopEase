      ...
      <div className="relative px-6 py-4">
        ...
        <div className="absolute inset-0 flex items-center justify-start ">
          <div className="text-black text-[50px] font-bold bg-opacity-50 px-6 py-3 rounded-lg ml-10">
            <div className="text-[12px] text-gray-500 mt-5">THE NEXT GENERATION</div>
            ...
            />
            <p className="text-[18px] mt-3 text-gray-800 font-medium">Get instant alerts for anyone who approaches,<br /> even if they don’t press the headphone.</p>
          </div>
        </div>
      </div>
